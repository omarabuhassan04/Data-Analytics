-- الهجرة الأولى — PostgreSQL
--
-- كانت هذه الهجرة مكتوبة بلهجة SQLite (AUTOINCREMENT / DATETIME) بينما
-- datasource في schema.prisma يعلن "postgresql"، فكان `prisma migrate deploy`
-- يفشل عند أول هجرة ولا تُنشأ الجداول إطلاقًا. أُعيدت كتابتها بلهجة Postgres
-- بالأسماء والفهارس وسلوك المفاتيح الأجنبية نفسها — لا تغيير في المخطط.
