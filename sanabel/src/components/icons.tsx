...
/** شعار المجموعة: زهرة الكشافة داخل درع، بالسنابل */
export function Logo({ className }: { className?: string }) {
  return (
    <svg viewBox="0 0 48 48" className={cn("size-9", className)} aria-hidden>
      <path
        d="M24 3.5 41 9.5v14.2C41 33.4 33.6 41.4 24 44.5 14.4 41.4 7 33.4 7 23.7V9.5z"
        fill="currentColor"
        opacity="0.12"
      />
      <path
      ...
      {/* زهرة الزنبق */}
      <path
        d="M24 12.5 26.6 20h-5.2z"
        fill="currentColor"
      />
      <path
        d="M17.5 21c-1.8-1.2-3.2-.4-3.2 1.2 0 1.8 2 3.2 4.6 3.4M30.5 21c1.8-1.2 3.2-.4 3.2 1.2 0 1.8-2 3.2-4.6 3.4"
        stroke="currentColor"
        strokeWidth="1.6"
        fill="none"
        strokeLinecap="round"
      ...
      {/* سنبلتان */}
      <path
        d="M18 33c0-3 1.5-5 3.4-6M30 33c0-3-1.5-5-3.4-6"
        stroke="currentColor"
        strokeWidth="1.6"
        strokeLinecap="round"
        fill="none"
